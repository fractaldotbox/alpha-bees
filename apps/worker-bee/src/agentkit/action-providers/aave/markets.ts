...
import type { AaveAsset } from "./aaveActionUtil";
...
export const AAVEV3_SEPOLIA_MARKET_CONFIG =
	markets.AaveV3Sepolia as MarketConfig;
...
export const AAVEV3_SEPOLIA = {
	...
	assets: {
		[markets.AaveV3Sepolia.ASSETS.USDC.UNDERLYING]:
			markets.AaveV3Sepolia.ASSETS.USDC,
...
export const AAVEV3_BASE_SEPOLIA = {
	...
	assets: {
		[markets.AaveV3BaseSepolia.ASSETS.USDC.UNDERLYING]:
			markets.AaveV3BaseSepolia.ASSETS.USDC,
	} as Record<string, AaveAsset>,
};
