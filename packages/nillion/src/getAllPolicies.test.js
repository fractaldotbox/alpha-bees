...
(0, vitest_1.describe)("get obj", function () {
    ...
    (0, vitest_1.test)("should return >0 objects", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(result[0]._id).toMatch(/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i);
                    return [2 /*return*/];
            }
        });
    }); });
